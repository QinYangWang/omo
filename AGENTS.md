...
omo 是 Pi Agent 的 Electron Desktop 与 Web 客户端。项目使用 Electron、React 19、Vite、Tailwind CSS v4、shadcn/ui（Base UI）、ai-elements，以及 in-process 的 `@earendil-works/pi-coding-agent` SDK。
...
- [docs/sessions.md](docs/sessions.md) — Pi Session 生命周期、历史分页、消息流与实时同步边界
...
- [docs/ui.md](docs/ui.md) — UI 组件约定、三列布局、标题栏与 surface
