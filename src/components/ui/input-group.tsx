...
export function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: the addon forwards pointer focus to its input group control.
    // biome-ignore lint/a11y/noStaticElementInteractions: the addon forwards pointer focus to its input group control.
    <div
